            ...
            if all_args.env_name == "StarCraft2":                
                ...
                if np.sum(incre_battles_game) > 0:
                    if all_args.use_wandb:
                        ...
                        writter.add_scalars("incre_win_rate",{"incre_win_rate": np.sum(incre_battles_won)/np.sum(incre_battles_game)}, total_num_steps)
                    ...
                    if all_args.use_wandb:
                        ...
                        writter.add_scalars("incre_win_rate",{"incre_win_rate": 0}, total_num_steps)
            ...
            while True:         
                ...
                if eval_episode >= all_args.eval_episodes:
                    if all_args.use_wandb:
                        ...
                        writter.add_scalars("eval_win_rate", {"eval_win_rate": eval_battles_won/eval_episode}, total_num_steps)
