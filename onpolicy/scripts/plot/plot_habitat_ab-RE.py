...
method_names = ['global_stack','global_stack_noattn']
label_names = ['SCP','SCP w.o. RE']
    ...
    for metric_name in metric_names:
        if metric_name == "auc":
            for step_name in step_names:
                ...
                plt.savefig(save_dir + map_name + "_" + step_name + '_' + metric_name + "_RE-module.png", bbox_inches="tight")
        ...
        if metric_name == "overlap":
            for ratio_name in ratio_names:
                ...
                plt.savefig(save_dir + map_name + "_" + ratio_name + '_' + metric_name + "_RE-module.png", bbox_inches="tight")
        ...
        if metric_name == "step":
            ...
            plt.savefig(save_dir + map_name + "_" + metric_name + "_RE-module.png", bbox_inches="tight")