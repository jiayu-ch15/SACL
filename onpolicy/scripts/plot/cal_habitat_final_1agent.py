...
train_method_names = ['xy','multi_dis','no_attn', 'grid_simple', 'ans','global_stack']#,'distill']
train_label_names = ['2_Heads','Multi_Dis','No_Attn',  'Grid_Simple','ANS','MAANS']#,'MAANS-TD']
metric_names = ['ratio','step','repeat']#auc','auc',
ratio_names = ['90ratio']
step_names = ['450step'] 
...
map_names = ['27']#['27']#'40','26']#
train_method_names = ['xy','multi_dis','no_attn', 'grid_simple', 'distill']
train_label_names = ['2_Heads','Multi_Dis','No_Attn',  'Grid_Simple','MAANS-TD']
