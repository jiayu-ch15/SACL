...
if __name__ == "__main__":
    map_names = ['2s3z','5m_vs_6m','1c3s5z','6h_vs_8z','corridor']
    title_names = [name.replace("_vs_"," vs. ") for name in map_names]
    label_names = ["MAPPO(FP)", "QMix(MG)", "RODE", "QPLEX", "CWQMix","AIQMix"]
    ...
    for map_name, title_name, ax in zip(map_names, title_names, axes):
        ...
        lines.append(ax.plot(x_step, median_seed, label = 'MAPPO', color='red'))
        ...
        lines.append(ax.plot(x_step, median_seed, label = 'QMix(AS)', color='limegreen'))
        ax.fill_between(x_step,
            median_seed - std_seed,
            median_seed + std_seed,
            color='limegreen',
        ...
        lines.append(ax.plot(x_step, median_seed, label = 'RODE', color='blue'))
        ax.fill_between(x_step,
            median_seed - std_seed,
            median_seed + std_seed,
            color='blue',
        ...
        lines.append(ax.plot(x_step, median_seed, label = 'QPLEX', color='purple'))
        ax.fill_between(x_step,
            median_seed - std_seed,
            median_seed + std_seed,
            color='purple',
        ...
        lines.append(ax.plot(x_step, median_seed, label = 'CWQMIX', color='saddlebrown'))
        ax.fill_between(x_step,
            median_seed - std_seed,
            median_seed + std_seed,
            color='saddlebrown',
        ...
        lines.append(ax.plot(x_step, median_seed, label = 'AIQMIX', color='gray'))
        ax.fill_between(x_step,
            median_seed - std_seed,
            median_seed + std_seed,
            color='gray',
...
plt.savefig(save_dir + "baselines_subplot.png", bbox_inches="tight")
