    ...
    for metric_name in metric_names:
        if metric_name == "auc":
            for step_name in step_names:
                ...
                plt.ylabel(step_name + '_' + metric_name, fontsize=20)
                plt.title(title_name, fontsize=20)
                plt.legend(loc='best', numpoints=1, fancybox=True, fontsize=20)

                plt.savefig(save_dir + map_name + "_" + step_name + '_' + metric_name + ".png", bbox_inches="tight")
        ...
        if metric_name == "overlap":
            for ratio_name in ratio_names:
                ...
                plt.yticks(fontsize=20)
                plt.xlabel('Timesteps', fontsize=20)
                plt.ylabel(ratio_name + '_' + metric_name, fontsize=20)
                plt.title(title_name, fontsize=20)
                plt.legend(loc='best', numpoints=1, fancybox=True, fontsize=20)

                plt.savefig(save_dir + map_name + "_" + ratio_name + '_' + metric_name + ".png", bbox_inches="tight")
        ...
        if metric_name == "step":
            ...
            plt.savefig(save_dir + map_name + "_" + metric_name + ".png", bbox_inches="tight")