...
algo_names = ['MAPPO','QMix','CDS','TiKick']
...
method_names = ['final_mappo','final_mappo_denserew','final_mappo_sparse','final_qmix','final_qmix_sparse','final_cds_qmix_denserew','final_cds_qmix']

algo_names = ['MAPPO(s-d)','MAPPO(u-d)','MAPPO(s)','QMix(s-d)','QMix(s)','CDS(s-d)','CDS(s)']
