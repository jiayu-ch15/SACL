...
for map_name in map_names:
    plt.figure()
    ###################################PPO###################################
    exp_names = ['final_mappo', 'mappo_nomustalive', 'final_mappo_original', 'mappo_original_mustalive', 'mappo_catobs'] 
    label_names = ["modified", "modified-mask", "original-mask", "modified", "concat"]
    color_names = ['red','blue','limegreen','saddlebrown','gray']
