...
tags = ['final_mappo_rollout' + rt for rt in rollout_threads] + ['final_mappo','final_qmix','final_cds_qmix','final_cds_qplex','final_cds_qmix_denserew','final_cds_qplex_denserew']
