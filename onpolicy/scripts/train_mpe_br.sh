...
exp="full_psro_model3@40M-from_pretrained40M"
# exp="debug"
algo="mappo"
seed=0
# env config
...
blue_model_dir="/home/jiayu-ch15/onpolicy/onpolicy/scripts/results/MPE/simple_tag_corner/mappo/psro/wandb/run-20230421_131208-2pw62a01/files/40M"
