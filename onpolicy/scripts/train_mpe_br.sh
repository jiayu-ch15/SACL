...
exp="full_psro_model1@20M-from_pretrained40M"
# exp="debug"
algo="mappo"
seed=0
# env config
...
blue_model_dir="/home/jiayu-ch15/onpolicy/onpolicy/scripts/results/MPE/simple_tag_corner/mappo/full_psro/wandb/run-20230507_103940-sobiz3b3/files/20M"
