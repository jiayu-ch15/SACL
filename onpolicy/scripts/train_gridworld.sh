...
num_obstacles=0
algo="rmappo"
exp="rand_loc_step50_envs50_ppo5_lr1e-3_different_scene"
seed_max=1
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=6 python train/train_gridworld.py \
    ...
    --lr 1e-3 --critic_lr 1e-3 --use_merge --max_steps 100
done
