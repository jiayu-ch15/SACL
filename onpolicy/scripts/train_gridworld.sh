...
do
    ...
    --n_rollout_threads 2 --num_mini_batch 1 --num_env_steps 10000000 --ppo_epoch 10 --gain 0.01 \
    --lr 1e-3 --critic_lr 1e-3 --max_steps 100 --use_complete_reward --use_eval --n_eval_rollout_threads 2 --use_wandb
done
