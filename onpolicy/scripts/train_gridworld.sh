...
do
    ...
    --num_obstacles ${num_obstacles} --cnn_layers_params '16,3,1,1 32,3,1,1 16,3,1,1' --hidden_size 64 --seed 3 --n_training_threads 1 \
    --n_rollout_threads 50 --num_mini_batch 1 --num_env_steps 50000000 --ppo_epoch 3 --gain 0.01 \
    --lr 5e-4 --critic_lr 5e-4 --max_steps 100 --use_complete_reward --use_merge --use_eval --n_eval_rollout_threads 10
done
