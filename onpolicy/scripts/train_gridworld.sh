...
num_obstacles=0
algo="rmappo"
exp="minigrid_world_res_add_direction_image_same_loc"
seed_max=1
...
do
    ...
    --n_rollout_threads 50 --num_mini_batch 1 --num_env_steps 20000000 --ppo_epoch 10 --gain 0.01 \
    --lr 7e-4 --critic_lr 7e-4 --use_same_location --use_merge
done
