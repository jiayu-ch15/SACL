...
num_obstacles=0
algo="rmappo"
exp="new_same_loc_step100_envs50_ppo3_lr5e-4_multiroom_grid_scene_asyn"
seed_max=1
...
do
    ...
    --lr 5e-4 --critic_lr 5e-4 --max_steps 100 --use_complete_reward --use_eval --n_eval_rollout_threads 10 --agent_view_size 7 --use_random_pos --use_same_location --use_merge --use_wandb
done