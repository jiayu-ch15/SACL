...
num_obstacles=0
algo="rmappo"
exp="same_loc_step50_envs50_ppo5_lr1e-3_different_scene_baseline"
seed_max=1
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=7 python train/train_gridworld.py \
    ...
    --lr 1e-3 --critic_lr 1e-3 --max_steps 100 --use_same_location
done
