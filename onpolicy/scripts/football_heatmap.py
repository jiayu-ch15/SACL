...
import pdb
data = np.load('/home/jiayu-ch15/onpolicy/onpolicy/scripts/results/Football/academy_run_pass_and_shoot_with_keeper/mappo/rps_v4@300M_True/run1/logs/cross_play_win_rate.npy')
...
plt.tight_layout()
# plt.show()
plt.savefig("../rps_v4@300M_True.png")