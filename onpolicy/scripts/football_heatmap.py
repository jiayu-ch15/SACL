...
import pdb
data = np.load('/home/jiayu-ch15/onpolicy/onpolicy/scripts/results/Football/academy_run_pass_and_shoot_with_keeper/mappo/rps@sacl_haveball_vs_psro100M/run1/logs/cross_play_win_rate.npy')
# labels=["sacl", "sp", "fsp", "psro", "NeuRD"]
labels=["sacl_haveball", "psro_100M"]
num_exp = len(labels)
padding = 3
...
plt.tight_layout()
# plt.show()
plt.savefig("../rps@haveball_psro.png")