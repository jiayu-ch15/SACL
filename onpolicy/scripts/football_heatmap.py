...
import pdb
data = np.load('/home/jiayu-ch15/onpolicy/onpolicy/scripts/results/Football/academy_run_pass_and_shoot_with_keeper/mappo/rps@400M_False/run1/logs/cross_play_win_rate.npy')
...
plt.tight_layout()
# plt.show()
plt.savefig("../rps@400M_False.png")