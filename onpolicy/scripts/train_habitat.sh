...
num_agents=2
algo="mappo"
exp="new_slam_rgbd_time_penalty_merge_partial_reward_rand55_rot_pos_center_single_local_ppo4"
exp="debug"
seed_max=1
...
do
    ...
    --slam_keys rgb depth --use_filter --use_max_map --train_slam --use_wandb
