...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=3,0,1 python train/train_habitat.py --scenario_name ${scenario} \
    ...
    --slam_keys rgb --use_max --use_max_map --use_merge_local --use_vector_agent_id --use_complete_reward
