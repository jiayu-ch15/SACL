...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=2 python train/train_habitat.py --scenario_name ${scenario} \
    ...
    --num_local_steps 15 --max_episode_length 100 --num_env_steps 3000000 --ppo_epoch 4 --gain 0.01 \
    ...
    --use_center --use_merge --use_time_penalty --use_wandb --wandb_name "mapping" --user_name "yang-xy20" --use_same_scene --scene_id 16 \
    --slam_keys 'rgb' --load_slam "../envs/habitat/model/pretrained_models/slam_best.pt" 
