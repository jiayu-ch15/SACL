...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=0,2 python train/train_habitat.py --scenario_name ${scenario} \
    ...
    --num_local_steps 15 --max_episode_length 60 --num_env_steps 3000000 --ppo_epoch 4 --gain 0.01 \
