...
num_agents=2
algo="mappo"
exp="new_16_main_time_penalty_merge_partial_reward55_rand_rot_pos_center_merge_local_ppo4"
seed_max=1
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=2,3 python train/train_habitat.py --scenario_name ${scenario} \
