...
num_agents=2
algo="mappo"
exp="new_no_orientation_nofc_repeat_time_penalty_merge_partial_reward_rand_all_rot_pos_center_merge_local_ppo4"
seed_max=1
...
do
    ...
    --slam_keys rgb --use_max --use_max_map --use_merge_local --use_repeat_penalty
