...
num_agents=2
algo="mappo"
exp="new_large31_merge_partial_reward_rand55_rot_pos_center_single_local_ppo4"
seed_max=1
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=0,1,2 python train/train_habitat.py --scenario_name ${scenario} \
    ...
    --num_local_steps 15 --max_episode_length 450 --num_env_steps 3000000 --ppo_epoch 4 --gain 0.01 \
    ...
    --eval_episodes 1 --use_same_scene --scene_id 31\
    --use_delta_reward --use_different_start_pos --use_complete_reward --use_merge_partial_reward \
    --use_center --use_merge --use_time_penalty --wandb_name "mapping" --user_name "yuchao"
