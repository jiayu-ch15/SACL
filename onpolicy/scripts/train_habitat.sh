...
num_agents=2
algo="mappo"
exp="new_no_orientation_nofc_time_penalty_merge_partial_reward_rand55_rot_pos_center_merge_filter_local_ppo4"
seed_max=1
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=5,6,7 python train/train_habitat.py --scenario_name ${scenario} \
    ...
    --slam_keys rgb --use_max --use_max_map --use_merge_local --use_filter_local
