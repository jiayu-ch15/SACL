...
num_adversaries=3
algo="rmappo"
exp="fixed_four_dirrew_encoder_1prey_obsmask_alpha0.5_view1.0_allreach"
seed_max=1
ulimit -n 234567
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=0 python train/train_human.py --direction_alpha 0.5 --view_threshold 1.0 --use_all_reach --add_direction_encoder --use_fixed_prey --use_pos_four_direction \
