...
num_adversaries=3
algo="rmappo"
exp="fixed_four_dirrew_encoder_1prey_obsmask_alpha0.005_view0.1"
seed_max=1
ulimit -n 234567
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=0 python train/train_human.py --direction_alpha 0.005 --view_threshold 0.1 --add_direction_encoder --use_fixed_prey --use_pos_four_direction \
