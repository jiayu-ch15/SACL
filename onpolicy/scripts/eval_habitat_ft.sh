...
exp="3agents_transform_global_rrt_local_fmm_eval21"
seed_max=1
...
do
    ...
    --split "train" --use_same_scene --scene_id 21 --eval_episodes 100 --use_eval --ifi 0.01 --seed 2 \
    --n_training_threads 1 --n_rollout_threads 1 --num_mini_batch 5 --max_episode_length 240 \
