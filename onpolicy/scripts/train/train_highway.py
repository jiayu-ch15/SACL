...
def parse_args(args, parser):
    ...
    parser.add_argument("--dummy_agent_type", type=str, default="RobustValueIteration", help='Available type is "ValueIteration" or "RobustValueIteration" or "MonteCarloTreeSearchDeterministic" or "DQN_agent".')
