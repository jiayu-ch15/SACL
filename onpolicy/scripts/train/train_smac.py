...
def parse_args(args, parser):
    ...
    parser.add_argument("--add_state_agent", action='store_true', default=False)
...
def main(args):
    ...
    if all_args.algorithm_name == "rmappo" or all_args.algorithm_name == "rmappg":
        ...
        assert (all_args.use_recurrent_policy and all_args.use_naive_recurrent_policy) == False, ("check recurrent policy!")
    else:
        raise NotImplementedError
