...
gif_dir = "/home/yuchao/project/onpolicy/onpolicy/scripts/results/Habitat/mappo/debug/run93/gifs"
...
for folder in filer_folders:
    ...
    imageio.mimsave(str(folder) + '/render.gif', frames, duration=0.001)
print("done!")