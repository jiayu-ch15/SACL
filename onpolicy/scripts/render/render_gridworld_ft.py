...
def parse_args(args, parser):
    ...
    parser.add_argument("--use_partial_reward", action='store_true', default=False,
                        help="use single partial reward")
    ...
    parser.add_argument("--apf_cluster_radius", type=float, default=0, help="APF. radius of clusters")
    parser.add_argument("--apf_k_attract", type=float, default=1.0, help="APF. coefficient of attract by frontiers")
    parser.add_argument("--apf_k_agents", type=float, default=1.0, help="APF. coefficient of repulsive by agents")
    parser.add_argument("--apf_AGENT_INFERENCE_RADIUS", type=float, default=5, help="APF. agent inference radius")
...
def main(args):
    ...
    elif all_args.algorithm_name in ['ft_rrt', 'ft_nearest', 'ft_utility', 'ft_apf']:
        pass
    else:
        raise NotImplementedError

    assert all_args.use_eval or all_args.use_render, ("u need to set use_eval or use_render be True")
    if all_args.algorithm_name in ['mappo', 'mappg', 'rmappo', 'rmappg']:
