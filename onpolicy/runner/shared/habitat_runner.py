...
class HabitatRunner(Runner):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.max_episode_length):
                ...
                for e in range (self.n_rollout_threads):
                    ...
                    if 'merge_overlap_ratio' in infos[e].keys():
                        self.env_info['merge_overlap_ratio'][e] = infos[e]['merge_overlap_ratio']
    ...
    def init_global_policy(self):
        ...
        self.env_infos['merge_overlap_ratio'] = deque(maxlen=length) 
        if self.use_eval:
    ...
    def init_env_info(self):
        ...
        self.env_info['merge_overlap_ratio'] = np.zeros((self.n_rollout_threads,), dtype=np.float32)
        if self.use_eval:
