...
from onpolicy.envs.highway.highway_env.envs.common.action import action_factory, Action, DiscreteMetaAction, ActionType
from onpolicy.envs.highway.highway_env.envs.common.observation import observation_factory, ObservationType
from onpolicy.envs.highway.highway_env.envs.common.finite_mdp import finite_mdp
from onpolicy.envs.highway.highway_env.envs.common.graphics import EnvViewer
from onpolicy.envs.highway.highway_env.vehicle.behavior import IDMVehicle, LinearVehicle
from onpolicy.envs.highway.highway_env.vehicle.controller import MDPVehicle
...
class AbstractEnv(gym.Env):
    ...
    def _simulate(self, action: Optional[Action] = None) -> None:
        ...
        for i in range(int(self.config["simulation_frequency"] // self.config["policy_frequency"])):
            ...
            self.road.act()
            self.road.step(self.config["dt"] / self.config["simulation_frequency"])
            self.time += 1
