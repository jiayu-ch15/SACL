...
from onpolicy.envs.highway.agents.common.abstract import AbstractStochasticAgent
from onpolicy.envs.highway.agents.common.exploration.abstract import exploration_factory
from onpolicy.envs.highway.agents.common.memory import ReplayMemory, Transition
...
class AbstractDQNAgent(AbstractStochasticAgent, ABC):
    def __init__(self, env, config=None, vehicle_id=0):
        ...
        self.exploration_policy = exploration_factory(self.config["exploration"], self.env.action_space[vehicle_id])
        self.training = True
