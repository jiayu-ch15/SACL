...
class HAPPO():
    ...
    def ppo_update(self, sample, turn_on=True):
        ...
        :turn_on: (bool) whether to update actor network.
    ...
    def train(self, buffer, turn_on=True):
        ...
        :param turn_on: (bool) whether to update actor network.
        ...
        for _ in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                value_loss, critic_grad_norm, policy_loss, dist_entropy, actor_grad_norm, imp_weights = self.ppo_update(sample, turn_on=turn_on)
