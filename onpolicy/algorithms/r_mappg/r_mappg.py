...
class R_MAPPG():
    ...
    def auxiliary_loss_update(self, sample):
        ...
        # Reshape to do in a single forward pass for all steps
        values, action_log_probs = self.policy.get_policy_values_and_logprobs(obs_batch, rnn_states_batch, masks_batch, available_actions_batch)
    ...
    def train(self, buffer):
        ...
        for k in train_info.keys():
            if k in ["action_loss","actor_grad_norm","kl_loss","ratio"]:
