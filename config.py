...
def get_config():
    ...
    # prepare
    parser.add_argument("--algorithm_name", type=str, default='check-lstm')
    ...
    parser.add_argument("--step_unknown", type=int, default=3)
    parser.add_argument("--unknown_decay", action='store_true', default=False)
    parser.add_argument("--decay_episode", type=int, default=100)
